...
class FSM(object):
    ...
    def __init__(self, init_state, states_dict, default_state=None):
        """
        ...
        If default_state isn`t None, that is a state, which will be taken in case
        of forbidden message.
        """
    ...
    def set_default_state(self):
        """
        This function allows user to define a 'default state' which FSM will take in case of wrong message.
        Disabled if when initializing default_state is None.
        """
    ...
    def update(self):
        ...
        """
        for i in range(len(self.__states_dict[self.__state])):
